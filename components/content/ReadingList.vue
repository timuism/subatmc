...
<template>
    <div class="space-y-12">
        ...
        <section>
            <h3 class="mb-4 text-2xl font-medium text-green-400 font-display">Now Reading</h3>
            <ol class="pl-6 space-y-8 border-l-2 border-green-400">
                <li v-for="{ title, author, status } in nowReading" :key="title">
                    <div class="font-sans">
                        <div class="flex flex-col items-start">
                            <h3 class="text-lg md:text-xl" :class="status === 'complete' ? 'text-gray-500' : 'text-black'">
                                {{ title }}
                            </h3>
                        </div>
        ...
        <section>
            <h3 class="mb-4 text-2xl font-medium text-yellow-400 font-display">Up Next</h3>
        ...
        <section>
            <h3 class="mb-4 text-2xl font-medium text-red-400 font-display">Backlog</h3>
        ...
        <section>
            <h3 class="mb-4 text-2xl font-medium text-gray-400 font-display">Complete</h3>
